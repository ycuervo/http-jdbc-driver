 ...
 * @version : 1.0
 */
public class AspJdbcConnection
        implements java.sql.Connection
{
    ...
    AspJdbcConnection(URL path, String sDSN, URLConnection connection, BufferedReader in)
            throws SQLException
    {
        connDB = path;
        this.sDSN = sDSN;
    ...
    public Statement createStatement()
            throws SQLException
    {
        Statement stNew = new AspJdbcStatement(this);
    ...
    BufferedReader getDataStream(final String sSQL)
            throws Throwable
    {
        final Object objRet[] = HttpJdbcDriver.getDataStream(connDB, sCookie, sSession, sDSN, null, null, null, sSQL);
